...
<head>
    ...
    <title>Rybiarze - Zarejestruj się!</title>
...
<body>
    ...
    <main class="login-main">
        <div class="login-main__wrapper">
            <form action="/api/register-script.php" method="post" autocomplete="off" id="registration_form">
                ...
                <div class="login-main__password-wrapper" data-validate="Password is required">
                    <input class="login-main__pawwsowrd" type="password" name="confirm_password" id="confirm_password"
                        placeholder="Powtórz Hasło" required>
                </div>
                <div class="login-main__statute" data-validate="Wymagane">
                    <input class="statute" type="checkbox" name="statute" id="statute" required>
